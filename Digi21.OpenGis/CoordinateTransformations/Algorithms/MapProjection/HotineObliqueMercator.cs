...
{
    [AuthorityOperation(Authority = "EPSG", AuthorityCode = "9812"), WktParameter(0, "latitude_of_center", ParameterType.Angular), WktParameter(5, "false_easting", ParameterType.Length), OpenGisMathTransform(ClassificationName = "hotine_oblique_mercator"), WktParameter(2, "azimuth", ParameterType.Angular), WktParameter(4, "scale_factor", ParameterType.Scalar), WktParameter(1, "longitude_of_center", ParameterType.Angular), WktParameter(3, "rectified_grid_angle", ParameterType.Angular), WktParameter(6, "false_northing", ParameterType.Length)]
    public sealed class HotineObliqueMercator : MapProjectionBase
    {
        public HotineObliqueMercator(IProjection parameters, bool inversa) => throw null;
